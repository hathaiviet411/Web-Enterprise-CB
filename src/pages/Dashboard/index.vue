				...
				<v-card>
					...
					>
						<template v-slot:[`item.actions`]>
							<v-icon normal style="color: #051367;">mdi-eye</v-icon>
							<!-- <v-icon normal class="mr-2" style="color: #051367;">mdi-pencil</v-icon> -->
							<!-- <v-icon normal style="color: #E84545;">mdi-delete</v-icon> -->
						</template>
					</v-data-table>
				</v-card>
			</v-col>
